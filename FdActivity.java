...
public class FdActivity extends Activity implements CvCameraViewListener {
    ...
    private float                  mRelativeFaceSize   = 0.2f; //0.2f
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(TAG, "creating current expression");
        //Mat a = new Mat();
    ...
    public Mat onCameraFrame(Mat inputFrame) {
        ...
        Log.v(TAG, ""+mGray.channels()+" "+mGray.depth()+" "+mGray.elemSize()+" "+mGray.type());
        ...
        if(facesArray.length>0){
        	...
        	Log.v(TAG, "faceRect"+faceRect.channels()+" "+faceRect.depth()+" "+faceRect.elemSize()+" "+faceRect.type());
